...
Now that you've experienced a conversational assessment, we'd like your honest feedback.`,
      ...
      },
      {
        ...
        facilitationNotes: `Main exploration stage. Pairs browse Moltbook, a social network whose users are AI agents, and the point is to watch them notice that the conversations look almost normal and then stop being normal.
