...
You should have read both articles before today's discussion:`,
    ...
    {
      type: "reading-link",
      slug: "chatgpt-is-a-blurry-jpeg-of-the-web-newyorker-ed2e",
      newTab: true,
    },
    {
      type: "markdown",
      content: `— argues LLMs are lossy compression, not understanding`,
    },
    {
      type: "reading-link",
      slug: "the-case-that-a-i-is-thinking-newyorker-d419",
      newTab: true,
    },
    {
      type: "markdown",
      content: `— responds to Chiang, arguing that compression *is* understanding

Please complete the preparation conversation below before class.
This is part of attendance for today's meeting.`,
    },
    { type: "preparation-chat", slug: "does-ai-understand" },
    {
      type: "markdown",
      content: `---
...
- The wrap-up should feel like a landing, not a lecture — one or two connecting observations is enough`,
  activity: {
    meetingSlug: "2026-03-05-does-ai-understand",
    startTime: "2:00pm",
    stages: [
      // ── Round 1 ──
      {
        label: "Round 1: The Blurry JPEG",
        estimatedTime: "12m",
        facilitationNotes: `This round focuses on Chiang's core analogy. Students may initially accept or reject it without examining it closely. Push them to be specific: what exactly is being "compressed"? Is a compression artifact the same as a hallucination? If discussion stalls, ask: "If you asked ChatGPT something and got a wrong answer, would you call that a compression artifact or a mistake? Does the framing matter?"`,
        content: [],
        group: {
          id: "round-1",
          groupKey: "ai-understand-discuss-2026-03-05",
          size: 2,
          autoComplete: false,
          content: [
            {
              type: "markdown",
              content: `### The Blurry JPEG
...
- [Somers, "The Case That A.I. Is Thinking"](/readings/2025-11-10-the-case-that-a-i-is-thinking-newyorker-d419)`,
      ...
      {
        label: "Round 1: Report Out",
        estimatedTime: "3m",
        transition: "Students capture their key discussion points",
        content: [
          {
      ...
      },
      {
        ...
        facilitationNotes: `Ask 2-3 pairs to share. Listen for whether students accept or push back on the compression analogy. Bridge to Round 2: "Chiang says compression means LLMs don't understand. But Somers has a direct response to that — what if compression *requires* understanding?"`,
        content: [
          {
            type: "markdown",
            content: `### Share Out
...
Geoff will ask a few pairs to share what they discussed. Listen for ideas that challenge or extend your own thinking.`,
          ...
          { type: "text-submission-board", id: "round-1-notes" },
        ],
      },
      // ── Round 2 ──
      {
        label: "Round 2: The Case for Understanding",
        estimatedTime: "12m",
        transition: "New partners discuss the scientific evidence",
        facilitationNotes: `This round introduces the scientific evidence. Students may find the neuroscience compelling or may resist the analogy between brains and LLMs. Push them to engage with the specifics: Tsao's face neurons are a real compression scheme in the brain — does that change the argument? The Hofstadter conversion is often the most provocative detail. If discussion stalls, ask: "What would it take to convince you that an AI system understands something?"`,
        content: [],
        group: {
          id: "round-2",
          groupKey: "ai-understand-discuss-2026-03-05",
          ...
          content: [
            {
              type: "markdown",
              content: `### The Case for Understanding
...
- [Somers, "The Case That A.I. Is Thinking"](/readings/2025-11-10-the-case-that-a-i-is-thinking-newyorker-d419)`,
      ...
      },
      {
        ...
        estimatedTime: "10m",
        transition: "Class reconvenes to share observations",
        facilitationNotes: `Ask pairs to share. Listen for how students weigh the neuroscience evidence — some will find it decisive, others will argue that similar mechanisms don't imply similar experiences. Bridge to Round 3: "So we've looked at whether the compression analogy holds and what the science says. Now let's get personal — Chiang's strongest argument may be about something you do every day: writing."`,
        content: [
          {
            type: "markdown",
            content: `### Share Out
...
Geoff will ask a few pairs to share what they discussed. Listen for ideas that challenge or extend your own thinking.`,
          ...
          { type: "text-submission-board", id: "round-2-notes" },
        ],
      },
      // ── Round 3 ──
      {
        label: "Round 3: The Writing Test",
        estimatedTime: "12m",
        transition: "New partners discuss what this means for writing",
        facilitationNotes: `This is often the most personal round. Chiang's writing argument resonates with students who have struggled with writing — the idea that a first draft is "original ideas, poorly expressed" maps to their experience. But many students also use AI to help them write, which complicates the picture. Push them to think about their own process: when they use AI to draft something, where does the "understanding" live? If discussion stalls, ask: "When you use AI to help you write, are you collaborating with something that understands, or are you using a fancy autocomplete?"`,
        content: [],
        group: {
          id: "round-3",
          groupKey: "ai-understand-discuss-2026-03-05",
...
- [Somers, "The Case That A.I. Is Thinking"](/readings/2025-11-10-the-case-that-a-i-is-thinking-newyorker-d419)`,
      ...
      },
      {
        ...
        estimatedTime: "10m",
        transition: "Class reconvenes to share observations",
        facilitationNotes: `Last share-out before wrap-up. This round often produces the most personal reflections. Let students share their experiences with AI-assisted writing. A good closing question: "Did anyone's partner change your mind about something today?"`,
        content: [
          {
            type: "markdown",
            content: `### Share Out
...
Geoff will ask a few pairs to share what they discussed. Listen for ideas that challenge or extend your own thinking.`,
          ...
          { type: "text-submission-board", id: "round-3-notes" },
        ],
      },
      // ── Wrap-up ──
      {
        ...
        facilitationNotes: `Keep this brief. The three rounds trace an arc: analogy (is compression = understanding?) → evidence (what does neuroscience say?) → application (what does this mean for writing and for us?). These articles won't be the last word — the question of AI understanding will keep evolving as the technology does. If a student said something particularly insightful during a share-out, call back to it.`,
        content: [
          {
            type: "markdown",
...
These two articles won't be the last word. The question of whether AI "understands" will keep evolving as the technology does — and as our understanding of our own cognition deepens. Pay attention to when this debate shows up in your own interactions with AI.`,
      ...
      // ── Feedback ──
      {
        ...
        content: [
          {
            type: "feedback",
            prompt: "What worked well about today's discussion? What would you change?",
          },
        ],
      },
    ],
