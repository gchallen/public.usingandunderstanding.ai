...
const meeting: MeetingDefinition = {
  frontmatter: {
    ...
    summary: "Finish your final project and show it to your classmates.",
  },
  intro: [
    {
      type: "markdown",
      content: `# Final Project Workshop 2
...
- Remind students the final project is 10% of the grade, graded on completion not polish.`,
  activity: {
    meetingSlug: "2026-04-30-final-project-workshop-2",
    startTime: "2:00pm",
    stages: [
      // ── Stage 1: Keep Building ──
      {
        label: "Keep Building",
        estimatedTime: "55m",
        softCap: "50m",
        hardCap: "57m",
        transition: "Pick up where you left off and finish your project",
        facilitationNotes: `Main work block. Students reopen their previous tool and keep building. Walk the room. Common failure modes are the same as Workshop 1: tool paralysis, fighting the AI on small details, silent struggle. Check in with the quiet ones.

If a student lost their prior link, check the Workshop 1 dashboard — but also remind them that starting over with a fresh description is often faster than fighting a stale chat. Chat-based AI tools have no memory of prior sessions anyway.

Give a two-minute warning around the 50-minute mark so everyone can get to a showable state before demos.`,
        content: [
          {
            type: "markdown",
...
Geoff will give a two-minute warning before demo time. Plan to be at a state where you can walk someone through your project by then.`,
      ...
      {
        label: "Show Your Neighbor",
        estimatedTime: "15m",
        transition: "Demo your project to your group",
        facilitationNotes: `Groups of 3 means each person gets roughly 4-5 minutes including questions. Float between groups, prompt shy demo-ers with "show us what it does," and note one or two memorable projects to call out in the final meeting on May 5.
...
This is celebration and exposure, not evaluation. No submission, no rubric, no slides. Just: here's what I made, here's what was hard, here's what surprised me.`,
        ...
        group: {
          id: "demo",
          groupKey: "fpw2-demos-2026-04-30",
          size: 3,
          autoComplete: false,
          content: [
            {
              type: "markdown",
              content: `### Show Your Neighbor
...
When you're listening, ask questions. Good ones: "What would you add if you had another hour?" "Did you try anything that didn't work?" "What tool ended up being the most useful?"`,
      ...
      // ── Stage 3: Feedback ──
      {
        label: "Feedback",
        estimatedTime: "5m",
        transition: "Quick feedback on the final project workshops",
        content: [
          {
            type: "feedback",
            prompt:
