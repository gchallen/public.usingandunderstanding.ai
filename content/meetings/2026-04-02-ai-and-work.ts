...
This is part of attendance for today's meeting.`,
    ...
    { type: "preparation-chat", slug: "ai-and-work" },
    {
      type: "markdown",
      content: `---
...
|-------|----------|------------|
| Round 1: Your Own Experience | 10m | 10m |
| Round 1: Share Out | 10m | 20m |
| Round 2: What's Actually Happening | 10m | 30m |
| Round 2: Share Out | 10m | 40m |
| Round 3: Horse or Coal? | 10m | 50m |
...
- Round 2 is where the Thompson piece comes alive. The key tension: individual happiness vs systemic displacement. Don't let pairs settle on one side.
- Round 3 gets personal. Students applying the horse-vs-coal test to their own careers can feel vulnerable. Create space for honest uncertainty.
- Round 4 often reveals that students haven't thought about governance at all. That's fine. The question is the point.
- During share-outs, look for pairs who disagreed with each other.`,
  activity: {
    meetingSlug: "2026-04-02-ai-and-work",
    startTime: "2:00pm",
    stages: [
      // ── Round 1: Your Own Experience ──
      {
        label: "Round 1: Your Own Experience",
        estimatedTime: "10m",
        transition: "Partners discuss their experience using AI as a tool",
        facilitationNotes: `This round grounds the discussion in direct experience. Every student just did the data analysis lab on Tuesday. Push them to be specific: what did AI do well? Where did it struggle? Did they feel like they were learning or just prompting? If students have used AI in jobs or internships, draw that out.`,
        content: [],
        group: {
          id: "round-1",
          groupKey: "ai-and-work-2026-04-02",
          size: 2,
          autoComplete: false,
          content: [
            {
              type: "markdown",
              content: `### Your Own Experience
...
**Discuss with your partner:** How did using AI for data analysis feel? Did it make you more capable, or did you feel like you were outsourcing your thinking? Have you used AI for work in other classes or jobs? When AI does something well, does that feel empowering or threatening?`,
      ...
      // ── Round 1: Share Out ──
      {
        ...
        facilitationNotes: `Ask 2-3 pairs to share. Listen for the tension between empowerment and displacement. Bridge to Round 2: "You've experienced AI as a tool for one afternoon. The coders in Thompson's piece live this every day. Let's look at what happens when AI becomes your entire work life."`,
        content: [
          {
            type: "markdown",
            content: `### Share Out
...
Geoff will ask a few pairs to share what they discussed. Listen for ideas that challenge or extend your own thinking.`,
      ...
      {
        label: "Round 2: What's Actually Happening",
        estimatedTime: "10m",
        transition: "New partners discuss how AI is changing work right now",
        facilitationNotes: `This round centers on Thompson's reporting. The key contradiction: individual coders are happier and more productive, but Block fired 4,000 people. Both things are true. Push pairs to engage with Lowrey's framework: are Thompson's happy coders "coal" (temporarily safe, even thriving) or are they next in line to be "horses" (the AI agents they manage will eventually manage themselves)?`,
        content: [],
        group: {
          id: "round-2",
          groupKey: "ai-and-work-2026-04-02",
          ...
          content: [
            {
              type: "markdown",
              content: `### What's Actually Happening to Work
...
**Discuss with your partner:** Can both things be true: workers happier AND expendable? Who in Thompson's piece is a "horse" and who is "coal"? What determines which?`,
            ...
            {
              type: "group-chat",
              slug: "ai-and-work-whats-happening",
            },
          ],
        },
      },
      // ── Round 2: Share Out ──
      {
        ...
        estimatedTime: "10m",
        transition: "Class reconvenes to share observations",
        facilitationNotes: `Ask pairs to share which workers they identified as horses vs coal and why. Bridge to Round 3: "You've been analyzing other people's jobs. Now apply it to yours. Are you a horse or coal?"`,
        content: [
          {
            type: "markdown",
            content: `### Share Out
...
Geoff will ask a few pairs to share what they discussed. Listen for ideas that challenge or extend your own thinking.`,
      ...
      {
        label: "Round 3: Horse or Coal?",
        estimatedTime: "10m",
        transition: "New partners apply the framework to their own futures",
        facilitationNotes: `This round gets personal. Students applying the horse-vs-coal test to their own career plans can feel vulnerable. Encourage honesty. Key insight from Lowrey: it's not just about skill. Radiologists survived partly because of FDA regulation. Factors beyond individual capability matter: regulation, professional licensing, unions, consumer preferences, cultural values. If a pair focuses only on skills, push them toward structural factors.`,
        content: [],
        group: {
          id: "round-3",
          groupKey: "ai-and-work-2026-04-02",
...
**Discuss with your partner:** Apply the horse-vs-coal test to your own future career or field of study. Are you more likely to be enhanced by AI or replaced by it? What about people who don't go to college? Lowrey says factors beyond skill matter: regulation, professional licensing, consumer preferences. What structural factors, beyond just being good at your job, might protect or endanger your career?`,
      ...
      // ── Round 3: Share Out ──
      {
        ...
        estimatedTime: "10m",
        transition: "Class reconvenes to share observations",
        facilitationNotes: `Ask pairs to share their horse-vs-coal self-assessments. Listen for structural factors beyond individual skill. Bridge to Round 4: "Whether AI helps or hurts workers isn't just about technology or skill. It's about choices: who makes them, and in whose interest."`,
        content: [
          {
            type: "markdown",
            content: `### Share Out
...
Geoff will ask a few pairs to share what they discussed. Listen for ideas that challenge or extend your own thinking.`,
      ...
      // ── Round 4: Who Decides? ──
      {
        ...
        estimatedTime: "10m",
        transition: "New partners discuss governance and worker agency",
        facilitationNotes: `Cassidy's piece is short but sharp. The electrician vs Amazon example shows that the same technology produces opposite outcomes depending on who controls the implementation. If students say "the government should regulate," push for specifics. If they say "the market will sort it out," ask them about the 4,000 Block employees. The governance vacuum is the point.`,
        content: [],
        group: {
          id: "round-4",
          groupKey: "ai-and-work-2026-04-02",
...
**Discuss with your partner:** Who should decide how AI is deployed in workplaces? The companies building it? The workers affected? Government regulators? What would "pro-worker AI" look like at Illinois, in your major, or in a campus job?`,
      ...
      // ── Round 4: Share Out ──
      {
        ...
        estimatedTime: "10m",
        transition: "Class reconvenes to share observations",
        facilitationNotes: `Last share-out. Listen for the range of governance positions. A good closing question: "Did anyone's partner change your mind about something today?"`,
        content: [
          {
            type: "markdown",
            content: `### Share Out
        ...
        content: [
          {
            type: "feedback",
            prompt:
              "Did today's rounds change how you think about AI and your own future work? Which round was worth the most time, and which would you cut?",
          },
        ],
      },
    ],
