...
const meeting: MeetingDefinition = {
  frontmatter: {
    date: "2026-02-17",
    semester: "spring2026",
    title: "AlphaGo: Intelligence, Creativity, and the Mirror",
    summary: "Pair discussion of themes from the AlphaGo documentary",
  },
  intro: [
    {
      type: "markdown",
      content: `# AlphaGo: Intelligence, Creativity, and the Mirror
...
This is part of attendance for today's meeting.`,
    ...
    { type: "preparation-chat", slug: "alphago" },
    {
      type: "markdown",
      content: `---
...
|-------|----------|------------|
| Round 1: Creativity | 15m | 15m |
| Round 1: Share Out | 5m | 20m |
| Round 2: Anthropomorphization | 15m | 35m |
| Round 2: Share Out | 5m | 40m |
| Round 3: The Mirror | 15m | 55m |
...
- Rounds 3 and 4 tend to generate the richest discussion — protect their time
...
- The wrap-up should feel like a landing, not a lecture — one or two connecting observations is enough`,
  activity: {
    meetingSlug: "2026-02-17-alphago-discussion",
    startTime: "2:00pm",
    stages: [
      // ── Round 1: Creativity ──
      {
        label: "Round 1: Creativity",
        estimatedTime: "15m",
        transition: "Partners discuss whether AI can be creative",
        facilitationNotes: `This round focuses on Move 37 and whether AI can be "creative." Students may initially say "no, it's just math" — push them to articulate what creativity requires beyond novelty and effectiveness. If discussion stalls, ask: "If a human had played Move 37, would you call it creative?"`,
        content: [],
        group: {
          id: "round-1",
          groupKey: "alphago-discuss-2026-02-17",
          size: 2,
          autoComplete: false,
          content: [
            {
              type: "markdown",
              content: `### Can AI Be Creative?
...
You can reference the [annotated transcript](/readings/2017-04-21-alphago) for specific quotes and moments.`,
      ...
      // ── Round 1: Share Out ──
      {
        ...
        facilitationNotes: `Ask 2-3 pairs to share. Listen for the tension between "creativity requires intent" and "creativity is about the output." Bridge to Round 2: "Many of you talked about what AlphaGo lacks — intention, understanding, personality. But notice how the people in the documentary talk about it..."`,
        content: [
          {
            type: "markdown",
            content: `### Share Out
...
Geoff will ask a few pairs to share what they discussed. Listen for ideas that challenge or extend your own thinking.`,
      ...
      {
        label: "Round 2: Anthropomorphization",
        estimatedTime: "15m",
        transition: "New partners discuss why we treat AI like a person",
        facilitationNotes: `Students will likely recognize anthropomorphism in others but not in themselves. Push them to reflect on their own language with ChatGPT/Claude — do they say "please" and "thank you"? Do they feel guilty closing a chat? The Julian Schrittwieser example is powerful: even a programmer who knows exactly how the system works still slips into treating it as an agent.`,
        content: [],
        group: {
          id: "round-2",
          groupKey: "alphago-discuss-2026-02-17",
          ...
          content: [
            {
              type: "markdown",
              content: `### Why Do We Treat AI Like a Person?
...
You can reference the [annotated transcript](/readings/2017-04-21-alphago) for specific quotes and moments.`,
      ...
      // ── Round 2: Share Out ──
      {
        ...
        estimatedTime: "5m",
        transition: "Class reconvenes to share observations",
        facilitationNotes: `Ask pairs to share examples from their own experience. Bridge to Round 3: "So we project personality onto AI — but the documentary also shows the reverse. Fan Hui says playing AlphaGo is like looking in a mirror. What does that mean?"`,
        content: [
          {
            type: "markdown",
            content: `### Share Out
...
Geoff will ask a few pairs to share what they discussed. Listen for ideas that challenge or extend your own thinking.`,
      ...
      // ── Round 3: The Mirror ──
      {
        label: "Round 3: The Mirror",
        estimatedTime: "15m",
        transition: "New partners discuss what AI reveals about us",
        facilitationNotes: `This is often the richest round. Fan Hui's "mirror" and "naked" metaphors are vivid. The "slack moves" insight — that humans confused "winning by a lot" with "winning safely" — is a concrete example of AI revealing a blind spot. Push students to think about their own blind spots: has an AI tool ever made them realize they were approaching a problem wrong?`,
        content: [],
        group: {
          id: "round-3",
          groupKey: "alphago-discuss-2026-02-17",
          ...
          content: [
            {
              type: "markdown",
              content: `### What Does AI Reveal About Us?
...
You can reference the [annotated transcript](/readings/2017-04-21-alphago) for specific quotes and moments.`,
      ...
      // ── Round 3: Share Out ──
      {
        ...
        estimatedTime: "5m",
        transition: "Class reconvenes to share observations",
        facilitationNotes: `This share-out often produces personal stories. Let a few students share, then bridge to Round 4: "Fan Hui went from devastation to using AlphaGo to become stronger. Lee Sedol found Move 78 — something the AI couldn't. What does that tell us about where this is all headed?"`,
        content: [
          {
            type: "markdown",
            content: `### Share Out
...
Geoff will ask a few pairs to share what they discussed. Listen for ideas that challenge or extend your own thinking.`,
      ...
      {
        label: "Round 4: Collaboration",
        estimatedTime: "15m",
        transition: "New partners discuss human-AI collaboration",
        facilitationNotes: `The Kasparov "centaur chess" reference is key — "weak human + machine + better process" beats "strong human + machine + inferior process." This round connects directly to students' lives. Push them beyond "AI is a tool" to think about what makes collaboration effective vs. frustrating. If discussion stalls, ask: "When has AI made you worse at something?"`,
        content: [],
        group: {
          id: "round-4",
          groupKey: "alphago-discuss-2026-02-17",
          ...
          content: [
            {
              type: "markdown",
              content: `### Are Humans and AI Better Together?

Move 37 showed AI finding what humans couldn't. Move 78 showed Lee Sedol finding what AI couldn't. After losing to Deep Blue, Kasparov proposed "centaur chess" — humans and AI playing together — and found that "a weak human + machine + better process" beat "a strong human + machine + inferior process." Fan Hui went from devastation to using AlphaGo to become a stronger player. And despite AI now being unbeatable at both chess and Go, interest in both games has *increased* — professional Go players actually [got better and more creative](https://www.henrikkarlsson.xyz/p/go) after AlphaGo, with 60% of the improvement coming from moves that *deviated* from AI suggestions.

But Cory Doctorow warns about the flip side: instead of humans being augmented by AI (centaurs), workers can end up as ["reverse centaurs"](https://pluralistic.net/2025/12/05/pop-that-bubble/) — humans serving as appendages to machines rather than the other way around.
...
You can reference the [annotated transcript](/readings/2017-04-21-alphago) for specific quotes and moments.`,
      ...
      // ── Round 4: Share Out ──
      {
        ...
        estimatedTime: "5m",
        transition: "Class reconvenes to share observations",
        facilitationNotes: `Last share-out before wrap-up. Listen for the tension between augmentation and dependence. A good closing question for pairs to share: "Did anyone's partner change your mind about something today?"`,
        content: [
          {
            type: "markdown",
            content: `### Share Out
...
Geoff will ask a few pairs to share what they discussed. Listen for ideas that challenge or extend your own thinking.`,
      ...
      // ── Wrap-Up ──
      {
        ...
        facilitationNotes: `Keep this brief. One or two connecting observations, not a lecture. The four rounds trace an arc: What can AI do? → Why do we react to it the way we do? → What does it show us about ourselves? → Where do we go from here? If a student said something particularly insightful during a share-out, call back to it.`,
        content: [
          {
            type: "markdown",
