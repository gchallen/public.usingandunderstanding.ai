---
id: role-discussion
title: Structured Role Discussion
covers:
  - group-chat
---
...
That is a discussion rubric requiring no authoring. Put it on the handout with real checkboxes.

**Give one student the chair card.** The card says: your job is not to have opinions. It is to make sure the quietest person has spoken in the last three minutes, to read the next unchecked objective aloud when the group stalls, and to tick a box only when the group has actually addressed it. Rotate on your call every four minutes so everyone chairs once.

**You are the evaluator.** Circulate with the roster. You are looking for exactly what the software looked for: objectives not yet met, and students not yet speaking. Two marks per group is enough. When you hear a group land something, say so and move on.

**Close with a written line.** Ninety seconds, one sentence each, in the takeaway box. This replaces the transcript, which is the only durable thing the software produced.
