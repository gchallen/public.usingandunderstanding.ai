...
This is a working guide to teaching CS 199 "Using and Understanding AI" without the website it was built around.

The course ran for the first time at Illinois in Spring 2026. It is a three-credit elective for students with no technical background and no prerequisites, meeting twice a week for seventy-five minutes. The goal is that students leave with a working mental model of how these systems function and better judgment about using them.

It was built on a custom website that does real work during class: it collects what students write, uses AI to sort and summarize it, runs group discussions, and checks that people did the reading. That software is not ready to hand to anyone else, and getting it there is not a project anyone has time for.

None of that is the course, though. The software was scaffolding around a set of classroom activities, and the activities travel.
