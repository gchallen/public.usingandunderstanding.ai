...
One student at a time. Budget about five minutes per section, so roughly 10 minutes each; the original allowed a student 50 minutes with the AI, which is not the same thing. Multiply by your class size before you commit to this: it is the expensive option and it is the better one.
