...
Take and defend positions on AI creativity, the mirror effect, and human-AI collaboration

## How to run it

One student at a time. Allow 5 minutes per section, so about **15 minutes each**. The original gave a student 50 minutes with the AI, which is not the same number and not comparable: software can ask fifteen follow-ups without getting tired. Multiply by your class size before you commit to this. It is the expensive option and it is the better one.
...
| Grade | Means |
| --- | --- |
| **E** Excellent | Articulates a clear, well-supported position with specific examples or reasoning, engages substantively with counterarguments, and demonstrates nuanced thinking — goes beyond surface-level opinions |
| **S** Satisfactory | Takes a clear position and supports it with adequate reasoning, but arguments lack depth, specificity, or engagement with complexity |
| **N** Needs Improvement | States a vague or unsupported position with notable gaps — offers opinions without reasoning or examples, or relies heavily on interviewer prompting to articulate a view |
| **U** Unsatisfactory | Unable to articulate a meaningful position — responses are vague, off-topic, or consist of agreeing with whatever the interviewer suggests |

## 1. Can AI Be Creative?

**What you are looking for:** Student articulates and defends a position on whether AI can be creative

**Open with something like:** Can AI be creative?

**Then, only where they have not got there on their own, get them to:** defend a position on whether AI can be creative; say what the strongest thing someone could say against that is, and what they make of it.
...
**What you are looking for:** Student articulates and defends a position on how AI serves as a mirror for human thinking

**Open with something like:** What does AI reveal about us?

**Then, only where they have not got there on their own, get them to:** defend a position on how AI serves as a mirror for human thinking; say what the strongest thing someone could say against that is, and what they make of it.
...
**What you are looking for:** Student articulates and defends a position on whether human-AI collaboration can be genuinely effective

**Open with something like:** Can humans and AI work together effectively?

**Then, only where they have not got there on their own, get them to:** defend a position on whether human-AI collaboration can be genuinely effective; say what the strongest thing someone could say against that is, and what they make of it.
...
**Student:** ______________________  **Date:** ____________  **Assessment:** Creativity and AI

| Section | Criterion | Met | Partly | Not reached | Questions I had to ask |
| --- | --- | --- | --- | --- | --- |
| 1 | Takes a clear position on whether AI can be creative |  |  |  |  |
| 1 | Supports position with specific reasoning or examples |  |  |  |  |
| 1 | Engages thoughtfully with counterarguments when challenged |  |  |  |  |
| 2 | Takes a clear position on how AI serves as a mirror for human thinking |  |  |  |  |
| 2 | Provides specific examples from the documentary or personal experience |  |  |  |  |
| 2 | Engages thoughtfully with counterarguments when challenged |  |  |  |  |
| 3 | Takes a clear position on the effectiveness of human-AI collaboration |  |  |  |  |
| 3 | Supports position with specific reasoning or examples |  |  |  |  |
