# End-of-Semester Quiz Practice — marking scheme
...
- *Engages with a probing follow-up that pushes beyond their initial explanation* → **Push your own explanation one step past your first answer: add the detail, limit, or qualification you left out**
- *Engages with a tension or counterpressure to that practice* → **Name something that works against that practice, and say how you would handle it**
- *Engages thoughtfully with a counterargument when challenged* → **Give the strongest argument against your own position, and say what you make of it**
...
| Grade | Means |
| --- | --- |
| **E** Excellent | Reflects with specificity, clear reasoning, and depth across all portions. Names concrete concepts, activities, practices, concerns, and shifts. |
| **S** Satisfactory | Reflects with reasonable specificity but explanations are brief or shallow. |
...
**Student:** ______________________  **Marker:** ____________  **Assessment:** End-of-Semester Quiz Practice
